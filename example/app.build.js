...
var _reckbone = __webpack_require__(1);
...
var _reckbone = __webpack_require__(2);
...
function addComp(comps) {
  if (comps.indexOf('Model') > -1) this.Model = _reckbone2.default;
}
...
var Model = function () {
  function Model() {
    ...
    var Reckbone = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    if (options.parse) attrs = this.parse(attrs, options) || {};else attrs = attributes;
    defaults = _overscore2.default.result(this, 'defaults');
    attrs = _overscore2.default.defaults(_overscore2.default.extend({}, defaults, attrs), defaults);
  ...
  _createClass(Model, [{
    ...
    value: function unset(attr, options) {
      return this.set(attr, void 0, _overscore2.default.extend({}, options, {
        unset: true
      }));
    }
  }, {
    ...
    value: function clear(options) {
      ...
      for (var key in this.attributes) {
        attrs[key] = void 0;
      }return this.set(attrs, _overscore2.default.extend({}, options, {
        unset: true
      }));
    }
  }, {
